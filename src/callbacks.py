...
def update_chart(year, province):
    ...
    layout = go.Layout(barmode='group', title='Distribution by Industry and Gender', xaxis=dict(title='Industry'), yaxis=dict(title='Count'), width = 600, legend=dict(x=0.5, y=1.1, orientation='h'))
...
def update_chart(year, province):
    ...
    layout = go.Layout(barmode='group', title='Distribution by Type of corporation and Gender', xaxis=dict(title='Type of corporation'), yaxis=dict(title='Count'), width = 400, legend=dict(x=0.5, y=1.1, orientation='h'))
